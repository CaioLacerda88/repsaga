...
| 33d | RPG / share-pipeline + post-session E2E batch — 3 IMPORTANT (finding-042 B3 PR cut, -043 exercise retirement, -045 weight unit toggle) + 1 folded (-055 unskip overflow-card tap). | 1.5–2d | IN FLIGHT |
...
Order: 33-discovery (DONE) → 33-triage (DONE) → 33a (DONE) → 33b (DONE) → 33c (DONE) → 33d (IN FLIGHT) → 33e → (33g/h reserved). PR 33f closed post-triage.
