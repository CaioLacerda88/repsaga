...
| **Data portability** — receive your workout history in a structured, machine-readable format | Art. 18 V | Art. 20 | Profile → Manage Data → **Export my data**. Generates a JSON file containing your profile, workout history, personal records, weekly plans, and RPG progression. Email fallback to `dpo@repsaga.app` remains available. |
